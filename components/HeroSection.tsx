  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
      <div className="text-center max-w-3xl mx-auto mb-16">
        ...
        <WordsReveal
          as="h1"
          text="Kira Takibinde Kaos Bitti."
        ...
        <WordsReveal
          as="p"
          text="Mülklerinizi, kiracılarınızı ve tahsilatlarınızı tek ekrandan yönetin. Kira artış oranını otomatik hesaplayın, gecikmeleri kaçırmayın."
