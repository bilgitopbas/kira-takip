...
export default function HeroSection() {
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
      ...
      {/* macOS tarzı ürün mockup + iPhone mockup */}
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center lg:items-end gap-10">
        <motion.div
        ...
        >
          <div className="relative w-[220px] h-[450px]">
            <div className="absolute inset-0 bg-black rounded-[2.5rem] p-2.5 shadow-2xl">
          ...
          <p className="text-xs text-slate-400 mt-4 mb-3">Mobil uygulamamızla her yerden yönetin</p>
