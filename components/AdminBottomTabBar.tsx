...
const TABS = [
  ...
  },
  {
    href: "/admin/gelirler",
    label: "Gelirler",
    icon: <span className="text-lg font-bold leading-none w-5 inline-flex items-center justify-center">₺</span>,
  },
  {
...
export default function AdminBottomTabBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800 flex items-stretch pb-[env(safe-area-inset-bottom)]">
      {TABS.map((tab) => {
