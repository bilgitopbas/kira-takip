...
const GOOGLE_ERROR_MESSAGES: Record<string, string> = {
  google_state: "Google girişi doğrulanamadı, lütfen tekrar deneyin.",
  google_not_configured: "Google ile giriş şu anda kullanılamıyor.",
  google_token: "Google ile giriş sırasında bir hata oluştu.",
  google_email: "Google hesabınızın e-postası doğrulanmamış.",
  google_unknown: "Google ile giriş sırasında beklenmeyen bir hata oluştu.",
};
