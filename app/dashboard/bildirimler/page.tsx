...
const TYPE_ICON: Record<string, string> = {
  PAYMENT_OVERDUE: "bg-red-50 text-red-500",
  RENEWAL_UPCOMING: "bg-amber-50 text-amber-500",
  FIVE_YEAR_3_MONTHS: "bg-blue-50 text-blue-500",
  FIVE_YEAR_1_MONTH: "bg-blue-50 text-blue-500",
  FIVE_YEAR_REACHED: "bg-purple-50 text-purple-500",
  MONTHLY_SUMMARY: "bg-emerald-50 text-emerald-500",
  ANNOUNCEMENT: "bg-[#17B6AE]/10 text-[#17B6AE]",
};
